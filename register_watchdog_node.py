...
new_entry = "            'safety_watchdog = hexacopter_control.safety_watchdog_node:main',\n"
modified = False

# Check if already registered
if any("safety_watchdog" in line for line in lines):
    print("✅ safety_watchdog is already registered.")
    exit(0)
...
if modified:
    with open(setup_path, 'w') as f:
        f.writelines(lines)
    print(f"✅ Successfully added safety_watchdog to setup.py")
else:
