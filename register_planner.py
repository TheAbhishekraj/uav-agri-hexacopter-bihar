...
new_entry = "            'coverage_planner = hexacopter_control.coverage_planner:main',\n"
modified = False

# Check if already registered
if any("coverage_planner" in line for line in lines):
    print("✅ coverage_planner is already registered.")
    exit(0)
...
if modified:
    with open(setup_path, 'w') as f:
        f.writelines(lines)
    print(f"✅ Successfully added coverage_planner to setup.py")
else:
