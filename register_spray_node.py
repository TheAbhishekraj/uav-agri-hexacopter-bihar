...
new_entry = "            'spray_controller = hexacopter_control.spray_controller_node:main',\n"
modified = False

# Check if already registered
if any("spray_controller" in line for line in lines):
    print("✅ spray_controller is already registered.")
    exit(0)
...
if modified:
    with open(setup_path, 'w') as f:
        f.writelines(lines)
    print(f"✅ Successfully added spray_controller to setup.py")
else:
